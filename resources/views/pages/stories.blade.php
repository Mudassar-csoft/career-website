...
<section class="top-bar">
    <div class="container">
        <div class="row">
            ...
            <div class="col-lg-12">
                <div class="img-hold">
                    <img src="{{ asset('assets/images/img107.png') }}" alt="Career Institute student success story">
                </div>
            </div>
        </div>
    </div>
...
@include('partials.site-faq-section', [
    'faqItems' => $storyFaqItems,
    'sectionExtraClass' => 'mb-5',
])
@if(false)
