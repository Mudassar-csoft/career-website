                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-lg-4">
                                                <div class="input-group mb-3">
                                                    <input type="text" class="form-control sc-iput" placeholder="Search Certification" aria-describedby="button-addon2">
                                                    <button class="btn" type="button" id="button-addon2"><img src="{{ asset('assets/images/icon19.png') }}" alt=""></button>
                                                </div>
                                            </div>
                                        </div>
                                    </form>
