            ...
            <div class="col-lg-4">
                <div class="rig-bar">
                    ...
                    <div class="s-link">
                        ...
                        <ul>
                            <li><a href="#"><img src="{{ asset('assets/images/icon116.svg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/icon117.svg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/icon118.svg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/icon119.svg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/icon120.svg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/icon121.svg') }}" alt=""></a></li>
                            <li><a href="#"><img src="{{ asset('assets/images/icon122.svg') }}" alt=""></a></li>
                        </ul>
                    </div>
                    <div class="c-de">
